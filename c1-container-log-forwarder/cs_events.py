...
if __name__ == '__main__':
   ...
   # with open("config.yml", "r") as ymlfile:
    ...
    '''
    # Using ENV variables
    collect(os.getenv('LF_C1_URL'),
            os.getenv('LF_C1_API_KEY'),
            os.getenv('LF_SIEM_HOST'),
            int(os.getenv('LF_SIEM_PORT')),
            os.getenv('LF_FACILITY'),
            int(os.getenv('LF_INTERVAL')),
            int(os.getenv('LF_OVERLAP')))
